...
# BFG 
alias bfg='java -jar /c/Users/shane/bfg-1.12.16.jar'
...
alias ebmtsched='cd /c/_projects/ebmt-sched'
alias ebmtapi='cd /c/_projects/ebmtapi'
alias ebmtapp='cd /c/3MHIS/ebmtapp'
alias ebmtdb='cd /c/_projects/ebmtdb'
alias emitters='cd /c/_projects/emitters'
alias icis='cd /c/_projects/icis'
alias icisdb='cd /c/_projects/icisdb'
